...
export const BATTLE_PROBLEMS = {
    ...
    mid: {
        ...
        opponentRule: '.panel .card p { color: #FF2E63; font-size: 14px; }',
        targetExtraRule: '.card.active .desc { color: #00E5FF; font-size: 20px; }',
        targetSelector: '.desc',
        expectedStyles: { color: '#00E5FF', 'font-size': '20px' },
